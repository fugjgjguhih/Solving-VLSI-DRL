...
class Encoder(nn.Module):
    ...
    def __init__( self,n_layers, n_head, d_k, d_v, d_inner, encoder_d=128,dropout=0.3):
...
class Actor(nn.Module):
    def __init__(self,hidden_dim,n_layers, n_head, d_k, d_v, d_inner, encoder_d=128,dropout=0.3):
        ...
        self.encoder = Encoder(n_layers, n_head, d_k, d_v, d_inner, encoder_d=self.encoder_d, dropout=dropout)
